...
> Part of the AI-SDLC roll-up; the workflows this describes as "live" (e.g. `e2e-triage.yml`) land in later slices — only the `@acme/ci-factory` tooling is present here.
